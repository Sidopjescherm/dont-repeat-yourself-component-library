...
7. Test jouw component lokaal doorlopend. Responsiviteit is eenvoudig, want je werkt met container queries. Test op [*accessibility*](https://github.com/fdnd-task/wcag-audit/blob/main/docs/INSTRUCTIONS.md) en [*performance*](https://github.com/fdnd-task/performance-audit/blob/main/docs/INSTRUCTIONS.md). Je hoeft in deze fase nog geen device- of user test uit te voeren.
