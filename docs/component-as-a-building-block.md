...
7. Test jouw component lokaal doorlopend. Responsiviteit is eenvoudig want je werkt met container-queries. Test op [*accessibility*](https://github.com/fdnd-task/wcag-audit) en [*performance*](https://github.com/fdnd-task/performance-audit), zorg ook dat je de handmatige tests uitvoert. Je hoeft in deze fase nog geen device- of user test uit te voeren.
